...
| Automated test cases | **73** | AST count from `tests/test_*.py` |
...
Build the source release artifacts after validation:

```bash
python scripts/build_release.py --output-dir ./release --no-git-ready
```
